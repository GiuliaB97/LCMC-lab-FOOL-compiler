grammar SimpleExpRightTrans; //quando creo un g4 devo mettere la dichiarazione grammar con lo stesso nome del file
...
exp: term (PLUS exp)?; 							/*E -> T E'-> diventa : */

term: value (TIMES term)?;							/* T-> V T'*/ 
