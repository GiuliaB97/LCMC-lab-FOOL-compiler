...
public class SimpleCalcSTVisitor extends SimpleExpDecBaseVisitor<Integer> {
	String indent;
  @Override
	...
	public Integer visitExpProd4(ExpProd4Context ctx) { 
		int res=Integer.parseInt(ctx.NUM().getText());//recupero il lessema che è un numero
