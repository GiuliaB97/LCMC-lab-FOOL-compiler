grammar SimpleExpTrans; //quando creo un g4 devo mettere la dichiarazione grammar con lo stesso nome del file
...
exp1: (PLUS term)* | 	/*epsilon*/; 		/* +T E'|epsilon con la notazione EBNF posso liberarmi di E' utilizzzando la stella di Kleene*/

term: value term1;							/* T-> V T'*/ 
term1: (TIMES value)* | 	/*epsilon */;	/*epsilon (non metto nulla) */ /* *V T'|epsilon */
